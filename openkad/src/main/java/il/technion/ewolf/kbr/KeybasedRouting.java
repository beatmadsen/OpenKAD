...
public interface KeybasedRouting {
     ...
     */
    void join(Collection<URI> bootstraps);
     ...
     */
    void register(String tag, MessageHandler handler);
     ...
     */
    void sendMessage(Node to, String tag, Serializable msg) throws IOException;
     ...
     */
    Future<Serializable> sendRequest(Node to, String tag, Serializable msg);
     ...
     */
    <A> void sendRequest(Node to, String tag, Serializable msg, A attachment, CompletionHandler<Serializable, A> handler);
